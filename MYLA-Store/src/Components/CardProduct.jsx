...
function CardProduct({ product, onClick }) {
  return (
    ...
    >
      ...
      />
      <h2 className="text-lg sm:text-2xl xl:text-3xl font-semibold text-gray-800 mb-5">{product.name}</h2>
      <p className="text-green-600 font-medium text-lg sm:text-2xl xl:text-3xl">{product.price}</p>
    </div>
  );
}
